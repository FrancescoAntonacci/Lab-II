...
corr[0, 0] = covm[0, 0]/(pylab.sqrt(covm[0, 0] * covm[0, 0]))
corr[0, 1] = covm[0, 1]/(pylab.sqrt(covm[0, 0] * covm[1, 1]))
corr[1, 0] = covm[1, 0]/(pylab.sqrt(covm[0, 0] * covm[1, 1]))
corr[1, 1] = covm[1, 1]/(pylab.sqrt(covm[1, 1] * covm[1,1]))
print(corr)
