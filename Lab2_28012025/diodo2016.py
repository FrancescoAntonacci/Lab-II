...
print('Start!\n') # scrive sulla console (terminale)
Directory='/home/studentelab2/doppi_fra/Lab2_28012025/'   # nome directory dove salvare i file dati
FileName=(Directory+'Diodo4.txt') # nomina il file dati <<<< DA CAMBIARE SECONDO GUSTO
