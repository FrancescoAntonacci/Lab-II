...
axes[0,1].set_xlabel("VC[arb.un]")
axes[0,1].set_ylabel("VR[arb.un]")
axes[0,1].legend()
...
axes[1,0].plot(tt2,vwr(tt2,wgenfun,a,dt,c),label="VR")
...
axes[1,1].set_xlabel("VC[arb.un]")
axes[1,1].set_ylabel("VR[arb.un]")
axes[1, 1].legend()
plt.show()