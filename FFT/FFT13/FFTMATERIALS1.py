...
# File paths
filepath = 'dataFFT13/'
filename = ['pieno1','buho1','quellechemifaccioio']
...
omega=np.array([4130.7,4007.0,3781.1]) *1e-3 
somega=np.array([0.5,0.5,0.1])*1e-3
...
fig.text(0.91, 0.22, 'Profilato segato', va='center', rotation='vertical', fontsize=18)
fig.text(0.91, 0.5, 'Profilato', va='center', rotation='vertical', fontsize=18)
fig.text(0.91, 0.77, 'Alluminio pieno', va='center', rotation='vertical', fontsize=18)


# Show all plots in a single figure
plt.savefig(filepath_images + 'FFTMATERIALS1.png')
plt.show()
